      ...
      return (
        <li class="relative">
          ...
          <div
            id="doubleDropdown"
            class={classNames(
              'fixed translate-x-44 z-10 top-0 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700',
              {
    ...
    return (
      <div class="relative">
        ...
        {this.state.show && (
          <div
            id="multi-dropdown"
            class="z-10 fixed bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700"
          >
