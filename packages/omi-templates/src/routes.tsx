...
export const routes = [
  ...
  createRoute('/shopCar/list', () => import('./pages/order/shopCar/list')),
  createAdminRoute('/shopCar/add', () => import('./pages/order/shopCar/add')),
  createRoute('/shipment/list', () => import('./pages/order/shipment/list')),
  createAdminRoute('/shipment/add', () => import('./pages/order/shipment/add')),
  createRoute('/quotation/list', () => import('./pages/order/quotation/list')),
