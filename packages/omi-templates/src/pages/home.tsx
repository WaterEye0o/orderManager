 ...
 * @LastEditTime: 2025-06-23 11:18:55
 * @LastEditors: 吴华彬
 * @Note: 
 */
    ...
    <div class='block'>
      <o-swiper>
        <div class='relative w-full'>
          <img src='/orderManager/static/swiper/1.png' class='block w-full' alt='...' />
        </div>

        <div class='relative w-full'>
          <img src='/orderManager/static/swiper/2.png' class='block w-full' alt='...' />
        </div>

        <div class='relative w-full'>
          <img src='/orderManager/static/swiper/3.png' class='block w-full' alt='...' />
        </div>
        <div class='relative w-full'>
          <img src='/orderManager/static/swiper/4.png' class='block w-full' alt='...' />
        </div>
      </o-swiper>
      <div class='flex flex-row align-self-center justify-self-center p-5'>
        <div class='relative'>
          <img style='width:228px;height:288px' class='mr-5' src='/orderManager/static/home_item_1/1.png' alt='...' />
          <div style='background: #00000090;color:#fff;width:228px;' class='absolute bottom-0 text-center'>
            定制化物流服务-发货状态订阅
          </div>
        </div>
        <div class='relative'>
          <img style='width:228px;height:288px' class='mr-5' src='/orderManager/static/home_item_1/2.png' alt='...' />
        ...
        <div class='relative'>
          <img style='width:228px;height:288px' class='mr-5' src='/orderManager/static/home_item_1/3.png' alt='...' />
          <div style='background: #00000090;color:#fff;width:228px;' class='absolute bottom-0 text-center'>
            施耐德电气合作伙伴积分商城
          </div>
        </div>
      ...
      <div style='background: #F1F1F1;' class='flex flex-row align-self-center justify-self-center p-5 w-full justify-center'>
        {[{
          imgSrc: '/orderManager/static/home_item_2/1.png',
          title: '现场服务平台',
          content: '客户可以在线申请现场服务 便捷地查询现场服务处理状态'
        }, {
          imgSrc: '/orderManager/static/home_item_2/2.png',
          title: '企业邮箱',
          content: '企业邮箱登录入口'
        }, {
          imgSrc: '/orderManager/static/home_item_2/3.png',
          title: '产品替换查询',
          content: '产品替换查询入口'
        }, {
          imgSrc: '/orderManager/static/home_item_2/4.png',
          title: 'MyCP客户服务平台',
          content: '施耐德电气客户服务平台'
      ...
      <div class='p-5 mt-5 flex flex-col items-center'>
        ...
        {[
          ...
          {v.map((_v)=><div  style='width:368px;box-shadow: 0px 0px 13px 0px rgba(0,0,0,0.1);' class='flex flex-row items-center justify-between p-2  mr-5'>
            ...
            <img  style='width:20px;height:20px' src='/orderManager/static/xiazai.png' />
          </div>)}
